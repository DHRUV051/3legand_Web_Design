  ...
  return (
    <main className="px-[32px] md:px-[60px] lg:px-[160px]">
      ...
      <section className="flex md:items-center md:justify-center space-x-[62px] overflow-auto">
        <div className="pb-[26px] border-b-[2px] border-[rgb(20,23,24)] flex space-x-[17px] w-[256px]">
          ...
          <h1 className="text-[16px] leading-[26px] font-semibold justify-center flex flex-col items-center w-[150px]">
            {" "}
            Shopping cart
          </h1>
        </div>
        <div className="pb-[26px] flex space-x-[17px] w-[256px]">
          <div className="bg-[rgb(177,181,195)] rounded-full md:py-[10px] md:px-[20px] flex flex-col items-center justify-center px-[22px] py-[10px]">
            <h1 className="text-[rgb(255,255,255)] font-semibold text-[16px] leading-[26px]">
              2
            </h1>
          </div>
          <h1 className="text-[16px] text-[rgb(177,181,195)] leading-[26px] font-semibold justify-center flex flex-col items-center w-[150px]">
            Checkout details
          </h1>
        </div>
