  ...
  return (
    <main className="px-[32px] md:px-[60px] lg:px-[160px]">
      <section className="space-y-[48px]">
        <div className="flex">
          <h1 className="font-medium text-[34px] leading-[38px]  md:text-[40px] md:leading-[44px] w-[10%] ">New Arrivals</h1>
        ...
        <div className={clsx(`transition-opacity ${inView ? "fade-in-card" : ""}`,"flex flex-col bg-white m-auto p-auto")}>
          <div className="flex overflow-x-scroll pb-10" id="scroll">
            <div ref={ref} className={clsx("flex flex-nowrap")}>
              {/* `transition-opacity ${inView ? "fade-in-card" : ""}`, */}
