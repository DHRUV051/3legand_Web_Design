      ...
      <section className="py-[32px] md:py-[48px] grid lg:grid-cols-4 grid-cols-2 md:gap-[24px] gap-x-[8px] gap-y-[24px]">
        <div className="bg-[rgb(243,245,247)] px-[16px] py-[32px] md:px-[16px] md:py-[32px] space-y-[16px]">
          ...
          <div className="space-y-[8px]">
            <h1 className="font-semibold text-[14px] leading-[22px] md:font-medium md:text-[20px] md:leading-[28px] text-[rgb(20,23,24)]">
              Free Shipping
            </h1>
            <h1 className="text-[14px] leading-[22px] font-medium text-[rgb(108,114,117)] md:leading-[24px]">
              Order above $200
            </h1>
          </div>
        </div>
